...
export default function App() {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-stone-50 text-slate-950 transition-colors dark:bg-[#110608] dark:text-white">
      <div className="fixed inset-0 -z-20 bg-[radial-gradient(circle_at_top_left,rgba(127,29,29,0.26),transparent_34%),radial-gradient(circle_at_80%_0%,rgba(190,18,60,0.18),transparent_32%),linear-gradient(180deg,rgba(255,247,247,0.95),rgba(255,251,251,0.98))] dark:bg-[radial-gradient(circle_at_top_left,rgba(153,27,27,0.28),transparent_34%),radial-gradient(circle_at_80%_0%,rgba(127,29,29,0.22),transparent_32%),linear-gradient(180deg,rgba(18,6,8,0.98),rgba(35,10,14,0.98))]" />
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-4 pb-12 pt-6 sm:px-6 lg:px-8">
        <section className="grid gap-6 pt-4 lg:grid-cols-[minmax(0,1fr)_390px] lg:items-start">
          <div className="animate-fade-in">
            <p className="text-sm font-semibold uppercase tracking-[0.28em] text-red-800 dark:text-red-200">
